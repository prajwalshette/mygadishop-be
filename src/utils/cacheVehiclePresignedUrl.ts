 ...
 */
export const cacheVehiclePresignedUrls = async (
  vehicle_id: string,
  imageUrls: string[] = [],
  docUrls: string[] = [],
 ...
 * @param vehicle_id - Vehicle ID
 */
export const getCachedVehiclePresignedUrls = async (vehicle_id: string): Promise<VehicleUrlData | null> => {
  try {
 ...
 * @param vehicle_id - Vehicle ID
 */
export const deleteCachedVehiclePresignedUrls = async (vehicle_id: string): Promise<boolean> => {
  try {
